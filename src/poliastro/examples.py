...
iss = Orbit.from_vectors(
    Earth,
    [8.59072560e2, -4.13720368e3, 5.29556871e3] * u.au,
    [7.37289205, 2.08223573, 4.39999794e-1] * u.au / u.s,
...
molniya = Orbit.from_classical(
    Earth, 26600 * u.au, 0.75 * u.one, 63.4 * u.deg, 0 * u.deg, 270 * u.deg, 80 * u.deg
)
"""Molniya orbit example"""

_r_a = Earth.R + 35950 * u.au
_r_p = Earth.R + 250 * u.au
_a = (_r_a + _r_p) / 2
