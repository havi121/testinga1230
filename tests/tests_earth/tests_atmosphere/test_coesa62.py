...
def test_outside_altitude_range_coesa62():
    with pytest.raises(ValueError) as excinfo:
        r0 = 6356.766 * u.au
        coesa62._check_altitude(701 * u.au, r0)
    assert (
...
coesa62_solutions = {
    0.5 * u.au: [284.900 * u.K, 9.54612e2 * u.mbar, 1.1673 * u.kg / u.m ** 3],
    1.0 * u.au: [281.651 * u.K, 8.98762e2 * u.mbar, 1.1117 * u.kg / u.m ** 3],
    10.0 * u.au: [223.252 * u.K, 2.64999e2 * u.mbar, 4.1351e-1 * u.kg / u.m ** 3],
    77.0 * u.au: [192.340 * u.K, 1.7725e-2 * u.mbar, 3.210e-5 * u.kg / u.m ** 3],
    86.0 * u.au: [180.65 * u.K, 3.4313e-3 * u.mbar, 6.617e-6 * u.kg / u.m ** 3],
    97.0 * u.au: [201.65 * u.K, 4.8709e-4 * u.mbar, 8.415e-7 * u.kg / u.m ** 3],
    103.0 * u.au: [225.65 * u.K, 1.9074e-4 * u.mbar, 2.945e-7 * u.kg / u.m ** 3],
    115.0 * u.au: [310.65 * u.K, 4.1224e-5 * u.mbar, 4.623e-8 * u.kg / u.m ** 3],
    132.0 * u.au: [600.65 * u.K, 1.0909e-5 * u.mbar, 6.327e-9 * u.kg / u.m ** 3],
    157.0 * u.au: [1065.65 * u.K, 4.0409e-6 * u.mbar, 1.321e-9 * u.kg / u.m ** 3],
    183.0 * u.au: [1301.65 * u.K, 1.9979e-6 * u.mbar, 5.347e-10 * u.kg / u.m ** 3],
    201.0 * u.au: [1405.65 * u.K, 1.3037e-6 * u.mbar, 3.231e-10 * u.kg / u.m ** 3],
    258.0 * u.au: [1662.65 * u.K, 4.0061e-7 * u.mbar, 8.394e-11 * u.kg / u.m ** 3],
    340.0 * u.au: [1962.65 * u.K, 9.8014e-8 * u.mbar, 1.740e-11 * u.kg / u.m ** 3],
    482.0 * u.au: [2373.85 * u.K, 1.3667e-8 * u.mbar, 2.006e-12 * u.kg / u.m ** 3],
    576.0 * u.au: [2549.85 * u.K, 4.5072e-9 * u.mbar, 6.158e-13 * u.kg / u.m ** 3],
    698.0 * u.au: [2698.45 * u.K, 1.2165e-9 * u.mbar, 1.570e-13 * u.kg / u.m ** 3],
}
